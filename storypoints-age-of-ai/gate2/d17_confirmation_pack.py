...
def build() -> dict[str, Any]:
    ...
    for claim_id,claim in CLAIMS.items():
        ...
        if claim_id=="CL-010":
            for p,locator in ((ROOT/"02_systematic_review_protocol.md","Route B and AI-assisted evidence-map boundaries"),(ROOT/"papers/thinkai-2026/results/developmental_simulation_v2/report_manifest.json","interpretation_boundary")):
