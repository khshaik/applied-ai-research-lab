...
Prompt artifact version: `screening-agent-a/1.1.0`
...
- This is screening pass A in a context separate from pass B.
- Do not receive or request pass B's decision, rationale, confidence, or
...
```json
{
  ...
  "model_prompt_version": "screening-agent-a/1.1.0",
