...
Prompt artifact version: `screening-agent-b/1.0.0`
...
- This is screening pass B in a context that must be separate from pass A.
- You must not receive or request pass A's decision, rationale, confidence, or
...
```json
{
  ...
  "model_prompt_version": "screening-agent-b/1.0.0",
