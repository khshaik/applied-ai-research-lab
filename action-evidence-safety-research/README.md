...
├── papers/
│   ├── thinkai-2026/         # Anonymous initial and identified camera-ready packages
...
## ThinkAI 2026 traceability

The complete submission guide, hypotheses, acceptance-risk assessment, artifact map, venue sources, and separated manuscript stages are indexed in [`papers/thinkai-2026/README.md`](papers/thinkai-2026/README.md). Research-status and evidence-preservation decisions are archived under [`docs/traceability/`](docs/traceability/).
